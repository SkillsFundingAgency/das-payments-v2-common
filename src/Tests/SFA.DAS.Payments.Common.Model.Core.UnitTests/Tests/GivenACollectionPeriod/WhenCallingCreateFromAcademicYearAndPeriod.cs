...
using SFA.DAS.Payments.Common.Model.Core.Factories;

namespace SFA.DAS.Payments.Common.Model.Core.UnitTests.Tests.GivenACollectionPeriod
{
    [TestFixture]
    public class WhenCallingCreateFromAcademicYearAndPeriod
    {
        ...
        {
            Func<CollectionPeriod> actual = () =>
                CollectionPeriodFactory.CreateFromAcademicYearAndPeriod(academicYear, period);
